...
public class ClassApp {
	...
	public static void main(String[] args) {
		...
		double print_result = c.getKimdahye();
		System.out.println("첫번째 원의 넓이는 " + print_result + " 입니다.");
		double print_result2 = c2.getKimdahye();
...
//메서드 오버로드(한개의 클래스에서 메서드이름은 고유값이라서 중복해서사용할 수 없어요. 단. 매개변수(인자값)가 다르면 가능합니다.
...
class Salesman extends Employee {
	public Salesman( ) {//클래스명과 똑같은 메서드가 생성자 메서드입니다.
