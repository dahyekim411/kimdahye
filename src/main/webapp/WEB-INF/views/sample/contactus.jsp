...
<h1>CONTACT</h1>
<div class="container">
<!-- 폼태그의 필수 속성, name,action-데이터를 전송할 대상,method-데이터를 전송하는 방법값 -->
<!-- input 한죽입력태그, textarea 여러줄입력 태그 -->
<!-- label은 이름표, 입력태그와 라벨은 1:1매칭이 되는 관계 -->
<form name="messagy-form" action="contactus.html" method="get">
...
<label for="messagy">메세지</label>
<textarea name="messagy" id="messagy" placeholder="내용을 입력"></textarea>
</div>
</fieldset>
...
<!-- form태그의 목적은 input,textarea,checkbox,radio,select데이터를 submit전송하는것이 목적 -->
<!-- 폼전송은 get(비보안용)post(보안용 입력/수정/삭제) -->
<!-- get방식은 유일하게 검색할때 사용합니다 -->
</div>
</section>
