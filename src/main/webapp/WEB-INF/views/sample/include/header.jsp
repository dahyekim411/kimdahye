...
<title>반응형홈페이지</title><!-- 문서의 제목을 브라우저 상단왼쪽에 표시 -->
...
<!-- span 자리를 차지하지 않는 영역 = 한뼘, px픽셀 화면에 표시되는 크기의 단위 -->
<!-- :콜런(속성:값,Key:Value), ;세미콜론(문장의 끝)-->
<style>
/*@미디어쿼리사용 메타태그viweport값필수*/
/*pc용 스타일 시작*/
...
<h1 class="logo">
<a href="/
">LOGO</a><!-- a태그는 페이지이동역할, href헤르프 속성값에 URL을 입력해서 이동 -->
...
<nav class="gnb">
<!-- 리스트를 모여조는 태그 ul(unOrdered List *.~,*.~),ol 1.~,2.~ -->
<ul>
<li><a href="/">HOME</a></li>
