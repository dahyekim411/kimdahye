...
<div class="wrapper">
  ...
  <!-- 관리자면 최상단 아이콘2개 Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <!-- 관리자화면 왼쪽메뉴부분 Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/resources/dist/img/user4-128x128.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <!-- 위 메뉴선택시 활성화 active 되는 것은 j쿼리로 만들예정입니다 -->
