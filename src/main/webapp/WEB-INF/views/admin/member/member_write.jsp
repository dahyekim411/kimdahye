        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">CREAT Member</h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user_id" id="user_id" placeholder="ID를 입력해 주세요" required>
                 	...
                 	값을 전송하게 되는데, 전송값을 저장하는 이름이  name이 되고, 위에서는 user_id입니다-->
                  </div>
                  <div class="form-group">
                  ...
                  <!-- 필수입력 값은 html5에서 지원하는 유효성 검사중 required속성을 사용해서 빈(null)체크(유효성검사)를 합니다. -->
                  </div>
                  <div class="form=group">
