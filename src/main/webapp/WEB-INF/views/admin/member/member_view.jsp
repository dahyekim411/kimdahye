...
<!-- jstl은 jsp의 표준태그 라이브러리입니다. java standard tag library -->
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                <!-- jsp에서 변수(저장소)를 사용하는 방법 Model로 수신한 $ 변수명으로 표시-->
                <%--${user_id2} --%>
                ...
                <hr>                
                <strong><i class="fas fa-layer-group"></i> levels</strong>
