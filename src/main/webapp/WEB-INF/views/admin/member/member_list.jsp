 ...
 <!-- 대시보드 본문 Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row"><!-- 부트스트랩의 디자인클래스 -->
          <div class="col-12"><!-- 그리드시스템중 12가로칼럼 width:100% -->
            <div class="card"><!-- 네모난디자인 -->
              <div class="card-header">
                <h3 class="card-title">멤버검색</h3>
            ...
            <!-- 버튼영역+페이징영역 시작 -->
            <div class="card-body">
            <a href="/admin/member/member_write" class="btn btn-primary float-right">CREAT</a>
            <!-- 부트스트랩 버튼클래서 디자인을 이용해서 a태그를 버튼모양으로 만들기(위) -->
            <!-- btn클래서명이 버튼모양으로 변경, btn-primary클래스명은 버튼색상을 바꿔줌 -->
            <!-- 
